            ...
            <div className="page-content">
                ...
                <div className="ranking-list">
                    {users.length > 0 ? users.map((user, index) => (
                        <div key={user.id || index} className="card list-item" style={{ padding: '12px 16px', borderRadius: '16px', marginBottom: '10px' }}>
                        ...
                        <p style={{textAlign: 'center', color: '#999', marginTop: '20px'}}>Cargando ranking...</p>
                    )}
                </div>
            </div>
        </>
